...
| [`v0.4.2-rc.2-candidate-preparation.md`](v0.4.2-rc.2-candidate-preparation.md) | I3.2's re-freeze after `rc.1`'s invalidation: full automated gate-table re-qualification (version identity, live `producer.build_revision`, clean-checkout regression/evaluation/repeatability, CI identity, hygiene, link validation) for `v0.4.2-rc.2`, `6461db6d51ee29e9c973e62b005aa84d5d95c077`, which includes the direct-marked-method-allowlist transport fix. Actual-client qualification, the GO/NO-GO decision, and publication remain later I3 sub-slices. |
