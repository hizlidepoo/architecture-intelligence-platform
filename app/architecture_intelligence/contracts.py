...
ArchitectureToolName = Literal["get_architecture_drift", "get_evidence", "get_service_dependencies"]
TOOL_NAMES: tuple[ArchitectureToolName, ...] = get_args(ArchitectureToolName)
